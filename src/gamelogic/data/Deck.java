...
class Deck {
    ...
    Deck(){
        ...
        cards.add(new CrewMember(2, Color.BLACK, "file:cards/CommsOfficer.png", "Comm's Officer",1, 1));
        cards.add(new CrewMember(3, Color.ALICEBLUE, "file:cards/RedShirt.png", "Red Shirt",1, 1));
        cards.add(new CrewMember(4, Color.ANTIQUEWHITE, "file:cards/ScienceOfficer.png", "Science Officer",1, 1));
        ...
        cards.add(new CrewMember(8, Color.CRIMSON, "file:cards/Tra." +
                "" +
                "nsporterChief.png", "Transporter Chief",0, 1));
